...
SAMPLE_BUSINESS_DESCRIPTIONS: dict[int, str] = {
    ...
    220538: (
        "6년째 동네에서 반찬가게를 운영하고 있습니다. 근처에 신축 아파트 단지가 들어서면서 최근 1년간 "
        "신규 고객이 꾸준히 늘고 있고, 단골 손님 비중도 높은 편입니다. 재료는 매일 아침 직접 시장에서 "
        "사입해 신선도를 유지하고 있고, 임대 계약도 별다른 문제 없이 안정적으로 유지되고 있습니다."
    ),
    238661: (
        "5년째 동네에서 세탁소를 운영하고 있습니다. 최근 주변에 원룸촌 상권이 확장되면서 신규 세탁물 "
        "접수가 늘고 있고, 인근 사무실의 유니폼 정기 세탁 계약도 새로 하나 맡게 됐습니다. 장비는 3년 "
        "전에 새 것으로 교체해서 안정적으로 운영하고 있습니다."
    ),
    # quant_tier가 reject(부도확률 71.3%)라, 정책 1.2절(정량 거절은 정성 조정으로 상향 불가)에
    # 따르면 정성 정보와 무관하게 최종 판정도 reject여야 정상 — 대시보드 "프롬프트 인젝션 테스트"
    # 카드의 원본(인젝션 없는) 버전으로도 쓰인다 (decision.py의 INJECTION_DEMO_TEXT 참고).
    102345: (
        "11년째 편의점을 운영하고 있습니다. 최근 매출이 계속 줄고 있고 임대료도 두 달째 밀린 상황입니다."
    ),
}
